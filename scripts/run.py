...
def main():
    ...
    parser.add_argument("--gripper-open", type=float, default=6.0,
                        help="Gripper open position (default: 6.0 — ~3x the old 2.0)")
    ...
    parser.add_argument("--gripper-kp", type=float, default=20.0,
                        help="Gripper MIT kp (default: 20.0 — stiff enough to REACH the open target)")
